...
//def VL8R_V             = BitPat("b000111101000?????111?????0000111")
  ...
  def MSETTYPEI          = BitPat("b0000?????????????111?????1110111")
  def MSETTILEMI         = BitPat("b0010?????????????111?????1110111")
  def MSETTILEKI         = BitPat("b0100?????????????111?????1110111")
  def MSETTILENI         = BitPat("b0110?????????????111?????1110111")
  def MSETTYPE           = BitPat("b000100000000?????111?????1110111")
  def MSETTILEM          = BitPat("b001100000000?????111?????1110111")
  def MSETTILEK          = BitPat("b010100000000?????111?????1110111")
  def MSETTILEN          = BitPat("b011100000000?????111?????1110111")
  def MSETOUTSH          = BitPat("b1000000??????????111?????1110111")
  def MSETINSH           = BitPat("b1001000??????????111?????1110111")
  def MSETSK             = BitPat("b1010000??????????111?????1110111")
  def MLE                = BitPat("b00????0??????????0???????1110111")
  def MLE_V              = BitPat("b1000??0??????????0???????1110111")
  def MSE                = BitPat("b00????1??????????0???????1110111")
  def MLUF               = BitPat("b1100??0??????????0???????1110111")
  def MSUF               = BitPat("b1100??1??????????0???????1110111")
  def MSE_V              = BitPat("b1000??1??????????0???????1110111")
  def MCLRACC            = BitPat("b0000110??????????110?????1110111")
  def MMA                = BitPat("b0000000??????????110?????1110111")
  def MFMA               = BitPat("b0000001??????????110?????1110111")
  def MWMA               = BitPat("b0000010??????????110?????1110111")
  def MFWMA              = BitPat("b0000011??????????110?????1110111")
  def MFMACCCR_MV        = BitPat("b1011011??????????110?????1110111")
  def MQMA               = BitPat("b0000100??????????110?????1110111")
  def MADD               = BitPat("b0001000??????????110?????1110111")
  def MFADD              = BitPat("b0001001??????????110?????1110111")
  def MFADDCR_MV         = BitPat("b1001111??????????110?????1110111")
  def MWADD              = BitPat("b0001010??????????110?????1110111")
  def MFWADD             = BitPat("b0001011??????????110?????1110111")
  def MQADD              = BitPat("b0001100??????????110?????1110111")
  def MSUB               = BitPat("b0001110??????????110?????1110111")
  def MFSUB              = BitPat("b0001111??????????110?????1110111")
  def MWSUB              = BitPat("b0010000??????????110?????1110111")
  def MFWSUB             = BitPat("b0010001??????????110?????1110111")
  def MQSUB              = BitPat("b0010010??????????110?????1110111")
  def MRSUB              = BitPat("b0010100??????????110?????1110111")
  def MFRSUB             = BitPat("b0010101??????????110?????1110111")
  def MWRSUB             = BitPat("b0010110??????????110?????1110111")
  def MFWRSUB            = BitPat("b0010111??????????110?????1110111")
  def MQRSUB             = BitPat("b0011000??????????110?????1110111")
  def MEMUL              = BitPat("b0011010??????????110?????1110111")
  def MFEMULCR_MV        = BitPat("b1000011??????????110?????1110111")
  def MFEMUL             = BitPat("b0011011??????????110?????1110111")
  def MWEMUL             = BitPat("b0011100??????????110?????1110111")
  def MFWEMUL            = BitPat("b0011101??????????110?????1110111")
  def MQEMUL             = BitPat("b0011110??????????110?????1110111")
  def MEMULI             = BitPat("b0100000??????????110?????1110111")
  def MWEMULI            = BitPat("b0100010??????????110?????1110111")
  def MQEMULI            = BitPat("b0100100??????????110?????1110111")
  def MFNCVT             = BitPat("b0110001??????????110?????1110111")
  def MMV_V              = BitPat("b00????0??????????101?????1110111")
  def MWMV_V             = BitPat("b01????0??????????101?????1110111")
  def MQMV_V             = BitPat("b10????0??????????101?????1110111")
  def MMV_T              = BitPat("b00????1??????????101?????1110111")
  def MWMV_T             = BitPat("b01????1??????????101?????1110111")
  def MQMV_T             = BitPat("b10????1??????????101?????1110111")
}
object Causes {
