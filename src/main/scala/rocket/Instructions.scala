...
object Instructions {
  ...
  def VLE1_V             = BitPat("b000000001011?????000?????0000111")
  def VSE1_V             = BitPat("b000000001011?????000?????0100111")
...
object CSRs {
  ...
  val vlenb = 0xc22
  val disinstrs      = 0xc23
  val fetchbubbles   = 0xc24
  val fetchlatency   = 0xc25
  val recybubbles    = 0xc26
  val icachemiss     = 0xc27
  val itlbmiss       = 0xc28
  val mispredinstret = 0xc29
  val brresteers     = 0xc2a
  val machineclears  = 0xc2b
  val divider        = 0xc2c
  val fpret          = 0xc2d
  val exestall       = 0xc2e
  val exeportall     = 0xc2f
  val exeport0       = 0xc30
  val exeport1       = 0xc31
  val exeport2       = 0xc32
  val exeport3       = 0xc33
  ...
  val l1miss         = 0xc36
  val l2miss         = 0xc37
  val storestall     = 0xc38
  val extmemoutsd    = 0xc39
  val sstatus = 0x100
  val sie = 0x104
  val stvec = 0x105
  ...
  val mdisinstrs      = 0xb20
  val mfetchbubbles   = 0xb21
  val mfetchlatency   = 0xb22
  val mrecybubbles    = 0xb23
  val micachemiss     = 0xb24
  val mitlbmiss       = 0xb25
  val mmispredinstret = 0xb26
  val mbrresteers     = 0xb27
  val mmachineclears  = 0xb28
  val mdivider        = 0xb29
  val mfpret          = 0xb2a
  val mexestall       = 0xb2b
  val mexeportall     = 0xb2c
  val mexeport0       = 0xb2d
  val mexeport1       = 0xb2e
  val mexeport2       = 0xb2f
  val mexeport3       = 0xb30
  ...
  val ml1miss         = 0xb33
  val ml2miss         = 0xb34
  val mstorestall     = 0xb35
  val mextmemoutsd    = 0xb36
  ...
  val disinstrsh      = 0xca0
  val fetchbubblesh   = 0xca1
  val fetchlatencyh   = 0xca2
  val recybubblesh    = 0xca3
  val icachemissh     = 0xca4
  val itlbmissh       = 0xca5
  val mispredinstreth = 0xca6
  val brresteersh     = 0xca7
  val machineclearsh  = 0xca8
  val dividerh        = 0xca9
  val fpreth          = 0xcaa
  val exestallh       = 0xcab
  val exeportallh     = 0xcac
  val exeport0h       = 0xcad
  val exeport1h       = 0xcae
  val exeport2h       = 0xcaf
  val exeport3h       = 0xcb0
  ...
  val l1missh         = 0xcb3
  val l2missh         = 0xcb4
  val storestallh     = 0xcb5
  val extmemoutsdh    = 0xcb6
  val mcycleh = 0xb80
  val minstreth = 0xb82
  ...
  val mdisinstrsh      = 0xba0
  val mfetchbubblesh   = 0xba1
  val mfetchlatencyh   = 0xba2
  val mrecybubblesh    = 0xba3
  val micachemissh     = 0xba4
  val mitlbmissh       = 0xba5
  val mmispredinstreth = 0xba6
  val mbrresteersh     = 0xba7
  val mmachineclearsh  = 0xba8
  val mdividerh        = 0xba9
  val mfpreth          = 0xbaa
  val mexestallh       = 0xbab
  val mexeportallh     = 0xbac
  val mexeport0h       = 0xbad
  val mexeport1h       = 0xbae
  val mexeport2h       = 0xbaf
  val mexeport3h       = 0xbb0
  val mexeport4h       = 0xbb1
  val mldstallh        = 0xbb2
  val ml1missh         = 0xbb3
  val ml2missh         = 0xbb4
  val mstorestallh     = 0xbb5
  val mextmemoutsdh    = 0xbb6
  val all = {
    val res = collection.mutable.ArrayBuffer[Int]()
    res += fflags
    res += frm
