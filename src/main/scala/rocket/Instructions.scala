...
//def VL8R_V             = BitPat("b000111101000?????111?????0000111")
  ...
  def MFLE               = BitPat("b00????1??????????0???????1110111")
  def MSE                = BitPat("b01????0??????????0???????1110111")
  def MFSE               = BitPat("b01????1??????????0???????1110111")
  def MCLRACC            = BitPat("b0000110??????????110?????1110111")
  def MOPA               = BitPat("b0000000??????????110?????1110111")
  def MFOPA              = BitPat("b0000001??????????110?????1110111")
  def MWOPA              = BitPat("b0000010??????????110?????1110111")
  def MFWOPA             = BitPat("b0000011??????????110?????1110111")
  def MQOPA              = BitPat("b0000100??????????110?????1110111")
  ...
  def MWSUB              = BitPat("b0010010??????????110?????1110111")
  def MFWSUB             = BitPat("b0010011??????????110?????1110111")
  def MQSUB              = BitPat("b0010100??????????110?????1110111")
  def MRSUB              = BitPat("b0010110??????????110?????1110111")
  def MFRSUB             = BitPat("b0010111??????????110?????1110111")
  def MWRSUB             = BitPat("b0011000??????????110?????1110111")
  def MFWRSUB            = BitPat("b0011001??????????110?????1110111")
  def MQRSUB             = BitPat("b0011010??????????110?????1110111")
  def MFNCVT             = BitPat("b0010001??????????110?????1110111")
  def MMV_V              = BitPat("b00????0??????????101?????1110111")
  def MFMV_V             = BitPat("b00????1??????????101?????1110111")
  def MWMV_V             = BitPat("b01????0??????????101?????1110111")
  def MFWMV_V            = BitPat("b01????1??????????101?????1110111")
  def MQMV_V             = BitPat("b10????0??????????101?????1110111")
  def MMV_T              = BitPat("b00????0??????????100?????1110111")
  def MWMV_T             = BitPat("b01????0??????????100?????1110111")
  def MQMV_T             = BitPat("b10????0??????????100?????1110111")
}
object Causes {
